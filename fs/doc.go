/*
fs library allows you to write well constructed Altid services
...
All buffer management occurs through writes to the ctl file. To open a buffer, for example, you write `open mybuffer > /path/to/service/ctl`
